...
<?php 
	...
	if($_SESSION["username"]== $master_id ){
...
?>
<img class="profile-user-img img-responsive"  width="200px" height="50px" src="<?php echo "../project/uploads/".$images ?>" alt=" &nbsp;User &#128274; profile picture">
