...
Client Password: <input type="password" name="client_password" required><br>
Name:            <input type="text" name="name" required><br>
Image		     <input class="img" type="file" name="fileToUpload" > </br>
GENDER:          &nbsp;&nbsp;<input type="radio" name="sex" required>&nbsp;Male &nbsp; <input type="radio" name="sex" required>&nbsp;Female<br><br>
...
GENDER:         &nbsp;&nbsp;<input type="radio" name="nominee_sex" required>&nbsp;Male &nbsp; <input type="radio" name="nominee_sex" required>&nbsp;Female<br><br>
